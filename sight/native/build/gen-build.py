...
#
# legal platforms: aix, beos, linux, netware, os2, os390, solaris, unix, windows
# 'make' users: aix, beos, linux, os2, os390, solaris, unix, windows (mingw)
#
PLATFORMS = [ 'aix', 'beos', 'hpux', 'linux', 'netware', 'os2', 'os400', 'os390', 'solaris', 'unix', 'windows' ]
MAKE_PLATFORMS = [
  ('unix', None),
  ('posix', None),
  ('aix', 'unix'),
