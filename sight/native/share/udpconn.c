...
J_DECLARE_CLAZZ = {
    NULL,
    NULL,
    SIGHT_CLASS_PATH "UdpConnection"
};
...
SIGHT_CLASS_UDEF(UdpConnection)
{
...
jobjectArray sight_new_udpconn_array(SIGHT_STDARGS, jsize len)
{
    if (_clazzn.a)
...
void sight_udpconn_set_local(SIGHT_STDARGS, jobject val)
{
