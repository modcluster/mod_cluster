...
public class TestChunkedMCPM extends TestCase {
    ...
    public void testChunkedMCPM() {
        ...
        // lifecycle = Maintest.createClusterListener("232.0.0.2", 23364, false, null, true, false, true);
        lifecycle = Maintest.createClusterListener("224.0.1.105", 23364, false, null, true, false, true);
