 ...
 * This API defines the integration point between mod_cluster and the servlet container.
 * @author Paul Ferraro
 */
public interface ContainerEventHandler
{
    ...
    * This event should be triggered only once, after the startup of the servlet container, but before triggering the {@link #start(Server)} event.
    ...
    * Closes any resources created in {@link #init(Server)}.
    */
   void shutdown();

   /**
    * Indicates the deployment of a new web application.
    * This event triggers a ENABLE-APP command for this context, if it is already started.
    ...
    * This event triggers an ENABLE-APP command for the specified context.
    ...
    * This event triggers a STOP-APP command for the context started by {@link #start(Context)}.
    ...
    * This event triggers a REMOVE-APP command for the specified context.
    ...
    * This event also processing of newly added/discovered proxies, and reset of any proxies in error.
    ...
    * This event triggers the configuration of each servlet engine, and the addition of all web application contexts.
    ...
    * This event triggers the removal of all web application contexts, and REMOVE-APP * of each engine.
