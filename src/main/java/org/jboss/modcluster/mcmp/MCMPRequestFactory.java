...
public interface MCMPRequestFactory
{
    ...
    * Used to create a STATUS request for a remote node.
    ...
    * This is used to ping a configured node from a proxy.
    ...
    * This is used to ping an unconfigured node from a proxy.
    ...
    * Used to create REMOVE-APP requests for remote nodes.
