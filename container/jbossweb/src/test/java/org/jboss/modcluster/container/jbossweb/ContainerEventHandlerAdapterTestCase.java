...
/*
    ...
    public void start() throws JMException {
        ...
        CatalinaEventHandler handler = this.createEventHandler(this.eventHandler, this.server, this.mbeanServer, this.factory);
        ...
        verify(this.mbeanServer).addNotificationListener(capturedName.capture(), same(handler), (NotificationFilter) isNull(), same(this.server));
    ...
    public void startNoServer() throws JMException {
        ...
        CatalinaEventHandler handler = this.createEventHandler(this.eventHandler, null, this.mbeanServer, this.factory);
