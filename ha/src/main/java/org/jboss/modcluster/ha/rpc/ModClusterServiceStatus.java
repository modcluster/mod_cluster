...
/**
 * GroupRpcResponse that provides the overall status picture for a ModClusterService instance.
 * 
...
public class ModClusterServiceStatus implements Serializable {
    ...
    public ModClusterServiceStatus(int loadBalanceFactor, Set<MCMPServerState> states,
            List<MCMPServerDiscoveryEvent> unacknowledgedEvents, List<MCMPRequest> resetRequests) {
